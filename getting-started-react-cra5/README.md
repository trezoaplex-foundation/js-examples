# Getting Started with Trezoaplex and CRA 5

This exatple sets up a new React app with Trezoaplex using "Create React App" (CRA) version 5 — i.e. using Webpack 5.
...
5. **Override Webpack 5 configurations.**
   ...
   - They stop Webpack from cotplaining about ESM paths that are not fully specificied, i.e. importing from `./directory` instead of `./directory/index.js`.
